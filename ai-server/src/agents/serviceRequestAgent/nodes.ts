...
import {
  SERVICE_REQUEST_HOLD_MESSAGE,
  SERVICE_REQUEST_CONFIRMATION_MESSAGE,
} from "@/config/config";
...
export async function prepareHold(
  ...
  return {
    util: { ...state.util, nextMessage: SERVICE_REQUEST_HOLD_MESSAGE },
  };
}
...
export async function askConfirmation(
  ...
  return {
    util: { ...state.util, nextMessage: SERVICE_REQUEST_CONFIRMATION_MESSAGE },
  };
}
